...
<head>
  ...
  <link rel="stylesheet" href="{{asset('admin-lte/plugins/bootstrap/css/bootsrtap.min.css')}}">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
      <img src="{{ asset('admin-lte/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">SHKOKO</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="#">SHKOKO</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
